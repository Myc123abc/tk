...
float cubic_bezier_sign(float2 uv, float2 p0, float2 p1, float2 p2, float2 p3){
	...
	float3 roots = float3(1e-38, 1e-38, 1e-38);
...
float cubic_bezier_dis(float2 uv, float2 p0, float2 p1, float2 p2, float2 p3){
	...
	float4 roots_drv = float4(1e-38, 1e-38, 1e-38, 1e-38);
	...
	float3 a = float3(1e-38, 1e-38, 1e-38);
	float3 b = float3(1e-38, 1e-38, 1e-38);
	...
	if(num_roots_drv==4){
		...
		if(num_roots_drv==2){
			...
			float3 roots_snd_drv=float3(1e-38, 1e-38, 1e-38);
			int num_roots_snd_drv=solve_cubic(c2,roots_snd_drv);

			float2 roots_trd_drv=float2(1e-38, 1e-38);
	...
	float d0 = min(dot(uv - p0, uv - p0), dot(uv - p3, uv - p3));
